 ...
 * Slug: frankel/footer-colophon-3-col
 * Categories: footer
	...
	<div class="wp-block-group alignwide" style="padding-top:var(--wp--preset--spacing--50);padding-bottom:var(--wp--preset--spacing--50)">
		...
		<div class="wp-block-columns" style="padding-top:var(--wp--preset--spacing--10)">
			...
			<div class="wp-block-column" style="flex-basis:57%">
				...
				<h2 class="wp-block-heading has-x-large-font-size"><?php esc_html_e( 'Keep up, get in touch.', 'frankel' ); ?></h2>
				<!-- /wp:heading -->
			</div>
			<!-- /wp:column -->
			<!-- wp:column {"width":"30%"} -->
			<div class="wp-block-column" style="flex-basis:30%">
				...
				<div class="wp-block-group">
					...
					<h3 class="wp-block-heading has-body-font-family has-medium-font-size"><?php esc_html_e( 'Contact', 'frankel' ); ?></h3>
					<!-- /wp:heading -->
					<!-- wp:paragraph -->
					<p><a href="#"><?php echo esc_html_x( 'info@example.com', 'Example email in site footer', 'frankel' ); ?></a></p>
					<!-- /wp:paragraph -->
				</div>
				<!-- /wp:group -->
			</div>
			...
			<div class="wp-block-column" style="flex-basis:30%">
				...
				<div class="wp-block-columns is-not-stacked-on-mobile">
					...
					<div class="wp-block-column">
						...
						<div class="wp-block-group">
							<!-- wp:heading {"level":3,"fontSize":"medium","fontFamily":"body"} -->
							<h3 class="wp-block-heading has-body-font-family has-medium-font-size"><?php esc_html_e( 'Follow', 'frankel' ); ?></h3>
							<!-- /wp:heading -->
							<!-- wp:paragraph -->
							<p><a href="#"><?php esc_html_e( 'Instagram', 'frankel' ); ?></a> / <a href="#"><?php esc_html_e( 'Facebook', 'frankel' ); ?></a></p>
							<!-- /wp:paragraph -->
						</div>
						<!-- /wp:group -->
					</div>
		...
		<div class="wp-block-group">
			...
			<div class="wp-block-group">
				...
				<p class="has-small-font-size"><?php esc_html_e( '&copy;', 'frankel' ); ?></p>
				<!-- /wp:paragraph -->
