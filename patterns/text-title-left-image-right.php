 ...
 * Slug: frankel/text-title-left-image-right
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column is-vertically-aligned-stretch" style="flex-basis:50%">
			...
			<div class="wp-block-group" style="min-height:100%">
				...
				<p class="has-heading-font-family has-x-large-font-size" style="line-height:1.2"><?php echo esc_html_x( 'Études offers comprehensive consulting, management, design, and research solutions. Every architectural endeavor is an opportunity to shape the future.', 'Headline for the About pattern', 'frankel' ); ?></p>
				<!-- /wp:paragraph -->
				...
				<div class="wp-block-group">
					...
					<p><?php echo esc_html_x( 'Leaving an indelible mark on the landscape of tomorrow.', 'Description for the About pattern', 'frankel' ); ?></p>
					<!-- /wp:paragraph -->
					...
					<div class="wp-block-buttons">
						...
						<div class="wp-block-button">
							<a class="wp-block-button__link wp-element-button"><?php echo esc_html_x( 'About us', 'Call to Action button text', 'frankel' ); ?></a>
						</div>
						<!-- /wp:button -->
					</div>
					<!-- /wp:buttons -->
		...
		<div class="wp-block-column is-vertically-aligned-center" style="flex-basis:50%">
			...
			<figure class="wp-block-image size-large is-style-rounded">
				<img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/images/museum.webp" alt="<?php esc_attr_e( 'A ramp along a curved wall in the Kiasma Museu, Helsinki, Finland', 'frankel' ); ?>" style="aspect-ratio:3/4;object-fit:cover" />
			</figure>
			<!-- /wp:image -->
		</div>
		<!-- /wp:column -->
